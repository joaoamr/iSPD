 ...
 */
public class CS_SwitchFIFO extends CS_Comunicacao implements Vertice {
    ...
    public CS_SwitchFIFO(String id, double LarguraBanda, double Ocupacao, double Latencia) {
