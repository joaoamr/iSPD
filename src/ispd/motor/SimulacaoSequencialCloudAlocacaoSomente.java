 ...
 */
public class SimulacaoSequencialCloudAlocacaoSomente extends Simulacao {
    private double time = 0;
    private PriorityQueue<EventoFuturo> eventos;
    
    public SimulacaoSequencialCloudAlocacaoSomente(ProgressoSimulacao janela, RedeDeFilasCloud redeDeFilas, List<Tarefa> tarefas) throws IllegalArgumentException {
